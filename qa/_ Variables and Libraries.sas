...
%let xver=xpef31; /* This must match the name of the XPEF folder being used */
...
%let thuver = 122; /* target housing units version id */
%let scver = 510; /* subregional control version id - deletes old and sets new*/
...
%let usver=474;
/* Urbansim_lite run_id 474 is used in XPEF31 */
