...
LEFT JOIN [estimates].[dbo].[BLK2010_JUR_POST2010] as y on x.centroid.STIntersects(y.shape) = 1
LEFT JOIN [estimates].[dbo].[BLK2010_JUR_POST2010] as z on x.shape.STIntersects(z.shape) = 1
...
LEFT JOIN [estimates].[dbo].[BLK2010_JUR_POST2010] as z on x.centroid.STIntersects(z.shape) = 1
)
