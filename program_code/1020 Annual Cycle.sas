...
%include "T:\socioec\Current_Projects\&xver\program_code\1023 Program Part 3 (Add Remove HH and HP).sas";

%include "T:\socioec\Current_Projects\&xver\program_code\1023a Macro--Jurswap.sas";
%jurswap (m=100); /* m controls maximum iterations */

%include "T:\socioec\Current_Projects\&xver\program_code\1024 Program Part 4 (Closing).sas";
