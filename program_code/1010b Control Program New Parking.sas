...
libname sql_dof odbc noprompt="driver=SQL Server; server=ddamwsql16; database=socioec_data;
Trusted_Connection=yes" schema=ca_dof;

libname sql_dim odbc noprompt="driver=SQL Server; server=ddamwsql16; database=demographic_warehouse;
...
/* Rerun for new parking only - do not modify other files */

%include "T:\socioec\Current_Projects\&xver\program_code\2000 Assembling ABM forecast data_np2.sas";
