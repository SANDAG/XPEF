...
/*%let xprev = xpef04;*/ /* specifying a version of xpef without the HP controls for jurisdictions */
%include "T:\socioec\Current_Projects\&xver\program_code\1012 NEW Jurisdiction HP controls.sas";

/* for now using static 2017 */
%include "T:\socioec\Current_Projects\&xver\program_code\1015 Target hh distribution (est 2017_04).sas";
