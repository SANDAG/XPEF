...
PROC IMPORT OUT=abm_lu_00 DATAFILE="T:\ABM\release\ABM\archive\version_13_3_3\input\&yrr.\mgra13_based_input&yrr..csv"
...
%let listabm=2016 2020 2025 2030 2035 2040 2045 2050;
%abm1;
...
proc sql;
create table final_01 as select x.*,x1.*,x2.*,x3.*,x4.*
...
inner join from_wu as x4 on x.mgra=x4.mgra
order by mgra;
quit;
