...
%let xver=xpef33; /* This must match the name of the XPEF folder being used */
...
%let thuver = 124; /* target housing units version id */
%let scver = 515; /* subregional control version id - deletes old and sets new*/
...
%let phver = 160; /* phase_yr_version_id in [urbansim].[urbansim].[urbansim_lite_parcel_control] */
...
%let usver=491; /*491 is used for xpef33*/
